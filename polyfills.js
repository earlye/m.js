console.log( "defining polyfills module...");
m.module({
    name : "polyfills",
    ...
    installPolyfill_Array_forEach: function() {
        console.log("installing Array.forEach polyfill");
